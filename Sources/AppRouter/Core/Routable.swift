...
public protocol Routable {
    ...
    @RouteActor func open(url: URL, animated animate: Bool, completion: (() -> Void)?) async throws
    @MainActor func open(url: URL, animated animate: Bool, completion: (() -> Void)?) throws
